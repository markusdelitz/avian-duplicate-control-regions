...
alifoldmaxcovar="/home/tyrarsin/Perl/Scripts-Work/aln/alifold_maxcovar.pl"
removegaponly="/home/tyrarsin/Perl/Scripts-Work/aln/remove-gaponly.pl"
reformataln="/home/tyrarsin/Perl/Scripts-Work/aln/reformat_aln.pl"
stripaln="/home/tyrarsin/Perl/Scripts-Work/aln/strip_aln.pl"
wd=$(pwd)
CM=OFF
STRIP=OFF
LOCARNATE=OFF
...
do
  ...
  RNAALIFOLD_OPTIONS="-t4 --aln --color -r --cfactor 0.6 --nfactor 0.5 -p --aln-EPS-cols=160 --aln-stk -f S"
